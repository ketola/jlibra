...
public class LibraVirtualMachineExcption extends SubmitTransactionException {

    public final long majorStatus;
    public final long subStatus;
    public final String message;

    public LibraVirtualMachineExcption(long majorStatus, long subStatus, String message) {
        super(String.format(
