package dev.jlibrac.client.jsonrpc;
...
public class LibraJsonRpcClientTest {
    ...
    private String url = "https://urltolibra";
    ...
    public void testErrorResponse() throws Exception {
        HttpResponse httpResponse = mock(HttpResponse.class);
        when(httpResponse.body()).thenReturn(
                "{\"libra_chain_id\":2,\"libra_ledger_version\":4875853,\"libra_ledger_timestampusec\":1604136151157457,\"jsonrpc\":\"2.0\",\"id\":\"0678e45d-b38b-423c-9d56-92116517fe82\",\"error\":{\"code\":-32602,\"message\":\"Invalid param account address(params[0]): should be hex-encoded string\",\"data\":null}}");
        when(httpClient.send(Mockito.any(), Mockito.any())).thenReturn(httpResponse);

        LibraJsonRpcClient jsonRpcClient = new LibraJsonRpcClient(url, httpClient,
                () -> "0678e45d-b38b-423c-9d56-92116517fe82");

        assertThrows(LibraServerErrorException.class,
                () -> jsonRpcClient.getAccount("b3f7e8e38f8c8393f281a2f0792a2849aa"),
